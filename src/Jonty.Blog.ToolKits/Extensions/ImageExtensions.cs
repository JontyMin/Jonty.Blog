...
namespace Jonty.Blog.ToolKits.Extensions
{
    public static class ImageExtensions
    {
        ...
        {
            watermarkImgPath = AbpStringExtensions.IsNullOrEmpty(watermarkImgPath) ? Path.Combine(Directory.GetCurrentDirectory(), "Resources/watermark.png") : watermarkImgPath;
