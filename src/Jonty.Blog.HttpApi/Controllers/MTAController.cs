...
namespace Jonty.Blog.HttpApi.Controllers
{
    ...
    public class MTAController : AbpController
    {
        private readonly IMTAService _mtaService;

        public MTAController(IMTAService mtaService)
        {
        ...
        {
            return await _mtaService.Ctr_core_data(start_date, end_date, idx);
        }
        ...
        {
            return await _mtaService.Ctr_realtime(idx);
        }
        ...
        {
            return await _mtaService.Ctr_realtime_heartbeat();
        }
        ...
        {
            return await _mtaService.Ctr_user_realtime(page);
        }
        ...
        {
            return await _mtaService.Ctr_user_compare(start_date, end_date);
        }
        ...
        {
            return await _mtaService.Ctr_user_portrait(start_date, end_date, idx);
        }
        ...
        {
            return await _mtaService.Ctr_area(type_ids, start_date, end_date, idx);
        }
        ...
        {
            return await _mtaService.Ctr_area_province(type_ids, start_date, end_date, idx);
        }
        ...
        {
            return await _mtaService.Ctr_operator(type_ids, start_date, end_date, idx);
        }
        ...
        {
            return await _mtaService.Ctr_client_para(start_date, end_date, type_id, idx);
        }
        ...
        {
            return await _mtaService.Ctr_client_content(start_date, end_date, type_id, type_contents, idx);
        }
        ...
        {
            return await _mtaService.Ctr_page_realtime(idx);
        }
        ...
        {
            return await _mtaService.Ctr_page_offline(start_date, end_date, page, idx);
        }
        ...
        {
            return await _mtaService.Ctr_page_url(start_date, end_date, urls, idx);
        }
        ...
        {
            return await _mtaService.Ctr_page_speed(start_date, end_date, type_contents, type, idx);
        }
        ...
        {
            return await _mtaService.Ctr_page_depth(start_date, end_date);
        }
        ...
        {
            return await _mtaService.Ctr_source_out(urls, start_date, end_date, idx);
        }
        ...
        {
            return await _mtaService.Ctr_page_land(urls, start_date, end_date);
        }
        ...
        {
            return await _mtaService.Ctr_page_exit(urls, start_date, end_date);
        }
        ...
        {
            return await _mtaService.Ctr_custom(custom, start_date, end_date, idx);
        }
        ...
        {
            return await _mtaService.Ctr_adtag(start_date, end_date, adtags, idx);
        }
